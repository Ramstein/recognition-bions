				...
				<nav class="navbar sticky-top navbar-expand-lg"><a class="navbar-brand" href="../index.php">Amazon <span>Rekognition</span></a><button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarNav" aria-controls="navbarNav" aria-expanded="false" aria-label="Toggle navigation"><span class="navbar-toggler-icon"></span></button>
					<div class="collapse navbar-collapse" id="navbarNav">
						<ul class="navbar-nav">
							...
							<li class="nav-item dropdown"><a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Services
								</a>
					...
					<form id="object-detection" action="object-detection-backend.php" method="post" enctype="multipart/form-data">
						<div class="row">
							<div class="col-md-5">
								...
								<div id="action"><button onclick="downloadRekognitionResults()">Download List</button></div>
							</div>
							<div class="col-md-7">
								<div id="image-holder">
									<div id="image-wrapper"><canvas id="canvas"></canvas><img id="image" src="../distr/img/od2-large.jpg" alt="Main Image"></div>
								</div>
								<div id="image-utilities" class="row">
									...
									<div id="sample-image" class="col-md-6">
										<h6>Try with Sample Images</h6><a href="" class="img-thumb"><img src="../distr/img/od1-large.jpg" alt="Demo Image"></a><a href="" class="img-thumb active"><img src="../distr/img/od2-large.jpg" alt="Demo Image"></a><a href="" class="img-thumb"><img src="../distr/img/od3-large.jpg" alt="Demo Image"></a>
									</div>
								</div>
							</div>
						</div>
