				...
				<div id="outer-wrapper">
					...
					<form id="facial-analysis" action="facial-analysis-backend.php" method="post" enctype="multipart/form-data" name="facial-analysis">
						<div class="row">
							...
							<div class="col-md-7">
								<div id="image-holder">
									<div id="image-wrapper"><canvas id="canvas"></canvas><img id="image" src="../distr/img/fa1-large.jpg" alt="Main Image"></div>
								</div>
								<div id="image-utilities" class="row">
									...
									<div id="sample-image" class="col-md-6">
										<h6>Try with Sample Images</h6><a href="" class="img-thumb active"><img src="../distr/img/fa1-large.jpg" alt="Demo Image"></a><a href="" class="img-thumb"><img src="../distr/img/fa2-large.jpg" alt="Demo Image"></a><a href="" class="img-thumb"><img src="../distr/img/fa3-large.jpg" alt="Demo Image"></a>
									</div>
								</div>
							</div>
						</div>
