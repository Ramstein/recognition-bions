							...
							<div class="col-md-7">
								<div id="image-holder">
									<div id="image-wrapper">
										<div id="image-buttons"><button id="image-view">View Content</button><button id="image-blur">Blur Content</button></div><canvas id="canvas"></canvas><img id="image" class="moderation" src="../distr/img/im2-large.jpg" alt="Main Image">
									</div>
								</div>
								<div id="image-utilities" class="row">
									...
									<div id="sample-image" class="col-md-6">
										<h6>Try with Sample Images</h6><a href="" class="img-thumb"><img src="../distr/img/im1-large.jpg" alt="Demo Image"></a><a href="" class="img-thumb active"><img src="../distr/img/im2-large.jpg" alt="Demo Image"></a><a href="" class="img-thumb"><img src="../distr/img/im3-large.jpg" alt="Demo Image"></a>
									</div>
								</div>
							</div>
						</div>
