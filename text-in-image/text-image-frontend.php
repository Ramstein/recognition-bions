					...
					<form id="text-image" action="text-image-backend.php" method="post" enctype="multipart/form-data">
						<div class="row">
							<div class="col-md-5">
								...
								<div id="action"><button onclick="downloadRekognitionResults()">Download Text</button></div>
							</div>
							<div class="col-md-7">
								<div id="image-holder">
									<div id="image-wrapper"><canvas id="canvas"></canvas><img id="image" src="../distr/img/tm2-large.jpg" alt="Main Image"></div>
								</div>
								<div id="image-utilities" class="row">
									...
									<div id="sample-image" class="col-md-6">
										<h6>Try with Sample Images</h6><a href="" class="img-thumb"><img src="../distr/img/tm1-large.jpg" alt="Demo Image"></a><a href="" class="img-thumb active"><img src="../distr/img/tm2-large.jpg" alt="Demo Image"></a><a href="" class="img-thumb"><img src="../distr/img/tm3-large.jpg" alt="Demo Image"></a>
									</div>
								</div>
							</div>
						</div>
